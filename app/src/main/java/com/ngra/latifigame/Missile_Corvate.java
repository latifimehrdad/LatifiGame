...
public class Missile_Corvate extends GameObject {
    ...
    public Missile_Corvate(Resources resources, int x, int y, int w, int h, int s, int numFrames, int HalfDeviceWidth) {
        ...
        if(x + width + 10<= HalfDeviceWidth) {
            ...
            spritesheet = BitmapFactory.decodeResource(
                    resources
                    , R.drawable.missile_corvate_ttb);
        } else {
            ...
            if(check <= 70) {
                ...
                spritesheet = BitmapFactory.decodeResource(
                        resources
                        , R.drawable.missile_corvate_btt);
            }
        }
