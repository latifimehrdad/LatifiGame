...
public class Mistake_BabyDiaper extends GameObject {
    ...
    public Mistake_BabyDiaper(Resources resources, int x, int y, int w, int h, int s, int HalfDeviceWidth) {
        ...
        spritesheet = BitmapFactory.decodeResource(
                resources
                , R.drawable.mistake_baby_diaper);
